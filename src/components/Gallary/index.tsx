...
// <div className="bg-paige text-paige">
    <section id="gallary" className="bg-Paige mx-auto min-h-full md:p-8">
      <motion.div
      ...
      <div className="flex-column mx-auto max-w-5xl">
        <Link
          heading="About"
          subheading="Get to know who I am"
